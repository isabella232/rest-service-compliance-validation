...
public class BudgetCheckCommandExecutor {
	
	private BudgetCheckCommandExecutor(){
		
	}
	
	public static ExecutionResults executeBusinessRules(InstitutionBudgetFactModel instBudgFactModel, ComplianceResults compResultsFired, StatelessKieSession kieSession)

	{
		...
		Command cmdFactModel = commandFactory.newInsert(instBudgFactModel, "instBudgFactModel");
		...
		Command cmdAgendaGrp = commandFactory.newAgendaGroupSetFocus(ComplianceConstants.BUDGET_AGENDAGROUP);
