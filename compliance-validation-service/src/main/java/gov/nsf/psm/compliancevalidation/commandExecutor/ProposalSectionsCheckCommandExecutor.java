...
public class ProposalSectionsCheckCommandExecutor {
	
	private ProposalSectionsCheckCommandExecutor(){
	}
	public static ExecutionResults executeBusinessRules(ProposalFactModel proposalFactModel, ComplianceResults compResultsFired, StatelessKieSession kieSession)

	{
		...
		Command cmdFactModel = commandFactory.newInsert(proposalFactModel, "ProposalFactModel");
		...
		Command cmdAgendaGrp = commandFactory.newAgendaGroupSetFocus(ComplianceConstants.SECTIONEXISTS_AGENDAGROUP);
