...
public class ProposalUpdateJustficationCheckCommandExecutor {
	
private ProposalUpdateJustficationCheckCommandExecutor(){
	
}
	public static ExecutionResults executeBusinessRules(ProposalUpdateJustificationFactModel propUpdateJustificationFactModel, ComplianceResults compResultsFired, StatelessKieSession kieSession)

	{
		...
		Command cmdFactModel = commandFactory.newInsert(propUpdateJustificationFactModel, "ProposalUpdateJustFactModel");
		...
		Command cmdAgendaGrp = commandFactory.newAgendaGroupSetFocus(ComplianceConstants.PROPOSALUPDATEJUST_AGENDAGROUP);
